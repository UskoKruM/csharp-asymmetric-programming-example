# Encriptación Asimétrica con RSA en C# y .NET | Clave pública y clave privada

Aprende a encriptar/desencriptar (de forma asimétrica) cadenas de textos (strings) utilizando el sistema criptográfico de clave pública/privada en C# y .NET, específicamente usando la clase RSA (Rivest-Shamir-Adleman). Conoce cómo codificar (encriptar) textos (como password o valores sensibles) de forma asimétrica utilizando funcionalidades nativas de C# y el algoritmo RSA.
